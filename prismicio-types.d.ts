...
export interface SettingsDocumentDataNavigationsItem {
  /**
   * Label field in *Settings → Navigations*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.navigations[].label
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  ...
  /**
   * CTA Button field in *Settings → Navigations*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: settings.navigations[].cta_button
...
/**
 * Item in *Bento → Default → Primary → Repeat*
 */
export interface BentoSliceDefaultPrimaryRepeatItem {
  /**
   * Title field in *Bento → Default → Primary → Repeat*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.repeat[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.TitleField;

  /**
   * Body field in *Bento → Default → Primary → Repeat*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.repeat[].body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * Image field in *Bento → Default → Primary → Repeat*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.repeat[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;

  /**
   * Wide field in *Bento → Default → Primary → Repeat*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: bento.default.primary.repeat[].wide
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
...
export interface BentoSliceDefaultPrimary {
  ...
  /**
   * Repeat field in *Bento → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.repeat[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  repeat: prismic.GroupField<Simplify<BentoSliceDefaultPrimaryRepeatItem>>;
}
...
/**
 * Item in *Integrations → Default → Primary → Icond*
 */
export interface IntegrationsSliceDefaultPrimaryIcondItem {
  /**
   * icon field in *Integrations → Default → Primary → Icond*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: integrations.default.primary.icond[].icon
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  icon: prismic.SelectField<
    "digitalocean" | "cloudflare" | "npm" | "figma" | "fly" | "github"
  >;
}
...
export interface IntegrationsSliceDefaultPrimary {
  ...
  /**
   * Icond field in *Integrations → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: integrations.default.primary.icond[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  icond: prismic.GroupField<Simplify<IntegrationsSliceDefaultPrimaryIcondItem>>;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BentoSlice,
      BentoSliceDefaultPrimaryRepeatItem,
      ...
      HeroSliceDefault,
      IntegrationsSlice,
      IntegrationsSliceDefaultPrimaryIcondItem,
