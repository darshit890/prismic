  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="mt- flex flex-col items-center md:flex-row">
          {slice.primary.icond.map((item, index) => (
            <React.Fragment key={index}>
            {index === Math.floor(slice.primary.icond.length / 2) && (
              <>
                <StylizedLogoMark />
            ...
            {index !== slice.primary.icond.length - 1 && (
              <div
                className={clsx(
                  "signal-line",
